...
var csrf = require('csurf');  // https://www.npmjs.com/package/csurf (crossite reference)
...
var hsts = require('./middlewares/hsts');
...
module.exports = function (app, passport) {
  /*
  // express-enforces-ssl also works behind reverse proxies (load balancers)
